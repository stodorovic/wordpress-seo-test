...
final class Test_WPSEO_Admin_Asset_Analysis_Worker_Location extends PHPUnit_Framework_TestCase {
	...
	public function test_get_url() {
		...
		// Default name.
		$expected_js = home_url() . '/wp-content/plugins/wordpress-seo-test/js/dist/wp-seo-analysis-worker-test' . $suffix . '.js';
	...
	public function test_get_url_with_name() {
		...
		$expected_js = home_url() . '/wp-content/plugins/wordpress-seo-test/js/dist/wp-seo-something-else-version' . $suffix . '.js';
